...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${mvcPath}/hb-bass-frame/mini/css/bass.all.min-0.0.1v.css"
	rel="stylesheet" type="text/css" />
<!--[if IE 7]>
...
<body ng-controller="mainContentCtrl"
	style="overflow: auto; background: url(${mvcPath}/hb-bass-frame/images/back.png) repeat  center center;">
		...
		<div id='topDetail' ng-controller="headerContentCtrl">
			<div id='topLine'>
				...
				<div class='Quick_Navigation'>
					<span>${(appName)?default("")}<!-- <a href="#">首页</a></span><span>|</span><span><a href="#">报表中心</a></span><span>|</span><span><a href="#">应用中心</a> --></span>
				</div>
				
				<div class="nav navbar-nav pull-right" style="margin-right: 0px;height: 50px;">
				<div class="logo-Users"></div>
				<ul class="nav navbar-nav pull-right">

					<!-- <li class="dropdown pull-right"><span href="#"
						class="dropdown-toggle" data-toggle="dropdown"
						style="padding-top: 12px; color: white; padding-bottom: 12px; padding-left: 15px;">
							<i class="icon-phone"></i> {{DataQualityLine}}
					</span></li> 
					<li class="dropdown pull-right"><span>|</span></li>-->
					<li id='user_info' class="dropdown pull-right dropdownHover"><a href="javascript:void(0)" 
						class="dropdown-toggle" data-toggle="dropdown"
						style="padding-right: 5px;"> 
						<!-- <i class="icon-user"></i> --> ${(user.name)!"空"} <b class="caret"></b>
					</a>
						<ul id="userinfo" class="dropdown-menu"
							style="background-color: #488ac4;">
							<li><a href="#" options="introduce"><i
									class="fa fa-user"></i> 介绍</a></li>
							<li><a href="#" options="setting"><i class="fa fa-cogs"></i>
									设置</a></li>
							<li><a href="${mvcPath}/login.html"><i
									class="fa fa-sign-out"></i> 注销</a></li>
						</ul></li>
					<li class="dropdown pull-right"><span>|</span></li>
					<li id='user_option' class="dropdown pull-right dropdownHover"><a
						href="javascript:void(0)" class="dropdown-toggle"
						data-toggle="dropdown"
						style=""> 
						<!-- <i class="icon-cogs"></i>--> 管理中心 <b class="caret"></b>
					</a> <!-- Dropdown menu -->
						<ul id="useroption" class="dropdown-menu"
							style="background-color: #488ac4;">
						</ul></li>
					<li class="dropdown pull-right searchArea" >
						<div class="isearch">
							<input class="isearchTxt" type="text" ng-model="searchValue" placeholder="4G流量 终端 4G">
							<a class="search-button" href="javascript:;" ng-click="search()" >
	...
	<script type="text/javascript"
		src="${mvcPath}/resources/lib/layer1.9/layer.js"></script>
	<script type="text/javascript"
	...
	<script type="text/javascript"
		src="${mvcPath}/hb-bass-frame/mini/js/bass.bug.all-0.0.1v.js"></script>
	<!-- <script type="text/javascript"
		src="${mvcPath}/hb-bass-frame/mini/js/bass.all.min-0.0.1v.js"></script> -->
