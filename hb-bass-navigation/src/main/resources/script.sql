...
DROP TABLE ST.FPF_ERROR_PAGE_INFO;
CREATE TABLE ST.FPF_ERROR_PAGE_INFO(
    ERRORPAGEID VARCHAR(20) NOT NULL,
...
---20170913应用表---
CREATE TABLE "ST"."FPF_IRS_APPLICATION"
 ("RESOURCE_ID"           VARCHAR(32)     NOT NULL,
  ...
  "LASTUPDATE"            TIMESTAMP DEFAULT CURRENT TIMESTAMP,
  "STATE"                 VARCHAR(8),
  "RESOURCE_IMG"          VARCHAR(300),
  "KEYWORDS"              VARCHAR(400),
  "SORT"                  INTEGER
 );
  
alter table ST.FPF_IRS_FAVORITES add column RESOURCE_TYPE  VARCHAR(20) NOT NULL;
