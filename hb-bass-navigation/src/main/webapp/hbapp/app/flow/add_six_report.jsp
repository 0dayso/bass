			...
			<div class="divinnerfieldset">
				<fieldset>
					<legend>
						<table>
							<tr>
								<td onclick="hideTitle(this.childNodes[0],'iframe5')" title="点击显示">
									<img flag='0' src="${mvcPath}/hbapp/resources/image/default/ns-collapse.gif"></img>
									&nbsp;超低T网流量基站：
								</td>
							</tr>
						...
						<table align="center" width="99%">
							<tr>
								<td>
									<iframe id="iframe5" frameborder=0 width="99%" height=500 scrolling=no ></iframe>
								</td>
							</tr>
						</table>
					</legend>	
			...
			<div class="divinnerfieldset">
				<fieldset>
					<legend>
						<table>
							<tr>
								<td onclick="hideTitle(this.childNodes[0],'iframe6')" title="点击显示">
									<img flag='0' src="${mvcPath}/hbapp/resources/image/default/ns-collapse.gif"></img>
									&nbsp;超高G网流量手机用户：
								</td>
							</tr>
						...
						<table align="center" width="99%">
							<tr>
								<td>
									<iframe id="iframe6" frameborder=0 width="99%" height=500 scrolling=no ></iframe>
								</td>
							</tr>
						</table>
					</legend>	
					<div id="grid5" style="display:none;"></div>
				</fieldset>
			</div>
</body>
<script>
function hideTitle(el,objId){
	...
	if(el.flag ==0)
	{
		...
		obj.style.display = "";
		if(objId=="iframe1"){
			obj.src="http://10.25.124.29/mvc/report/7941";
		}
		if(objId=="iframe2"){
			obj.src="http://10.25.124.29/mvc/report/7943";
		}
		if(objId=="iframe3"){
			obj.src="http://10.25.124.29/mvc/report/7945";
		}
		if(objId=="iframe4"){
			obj.src="http://10.25.124.29/mvc/report/7947";
		}
		if(objId=="iframe5"){
			obj.src="http://10.25.124.29/mvc/report/7946";
		}
		if(objId=="iframe6"){
			obj.src="http://10.25.124.29/mvc/report/7944";
		}
	}
	else
	{
...
function myhideTitle(){
	...
	var obj5= document.getElementById("iframe5");
	var obj6= document.getElementById("iframe6");
