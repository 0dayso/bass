...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css"
		...
		<link rel="stylesheet" type="text/css"
			href="${mvcPath}/hbapp/app/flowOperation/gprsAssessment/css/gprsAssessment.css" />
		...
		<script type="text/javascript" src="${mvcPath}/hbapp/app/flowOperation/gprsAssessment/js/gprsAssessment.js" charset=utf-8></script>	
  </head>
		...
		<div id="gprsAssessment">
			...
			<div class="bodyStyle">
				...
				<div class="chargeDiv" >
					...
					<div class="chargeCenter" id="chargeFlowchart"></div>
					<div class="chargeRight"  id="FlowMouchart"></div>
				</div>
				<div class="feeDivTitle"><h2>流量使用分布</h2></div>
				<hr>
				<div class="feeDiv"  id="FlowUsechart">
				</div>
