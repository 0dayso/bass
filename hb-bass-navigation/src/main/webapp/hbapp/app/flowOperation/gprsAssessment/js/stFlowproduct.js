...
function loadOrderUserData(){    
	...
	var fee_id=$('fee_id').value;
		Ext.Ajax.request({
			url:"/hbirs/action/stFlowproduct?method=getGprsOrderUser",
			params:{
				time_id:time_id,
				area_code:area_code,
	...
	var fee_id=$('fee_id').value;
		Ext.Ajax.request({
			url:"/hbirs/action/stFlowproduct?method=getGprsOrderNew",
			params:{
				time_id:time_id,
				area_code:area_code,
				county_code:county_code,
	...
	var fee_id=$('fee_id').value;
		Ext.Ajax.request({
			url:"/hbirs/action/stFlowproduct?method=getAvarageFlow",
			params:{
				time_id:time_id,
				area_code:area_code,
				county_code:county_code,
	...
	var fee_id=$('fee_id').value;
		Ext.Ajax.request({
			url:"/hbirs/action/stFlowproduct?method=getFlowCharge",
			params:{
				time_id:time_id,
				area_code:area_code,
				county_code:county_code,
	...
	var fee_id=$('fee_id').value;
		Ext.Ajax.request({
			url:"/hbirs/action/stFlowproduct?method=getFlowMou",
			params:{
				time_id:time_id,
				area_code:area_code,
				county_code:county_code,
	...
	var fee_id=$('fee_id').value;
		Ext.Ajax.request({
			url:"/hbirs/action/stFlowproduct?method=getFlowSTCharge",
			params:{
				time_id:time_id,
				area_code:area_code,
				county_code:county_code,
	...
	var feesql="select open_busi_type key,open_busi_type_name value from NWH.DIM_OPEN_BUSI_TYPE with ur";
