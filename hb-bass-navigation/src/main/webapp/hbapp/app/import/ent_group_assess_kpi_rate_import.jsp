 ...
 <legend>
   ...
   <table border=0 cellpadding="0" cellspacing="0">
      ...
      <td width="450"><div id="uploadDiv"></div></td>
        <td valign="top"><a style="text-decoration: underline;" href="${mvcPath}/hbirs/action/filemanage?method=downFromFtp&amp;remotePath=import&amp;fileName=结果值_比率.xls"><font color="blue"><b>数据模板(Excel)</b></font></a>&nbsp;<font color="red">请单击或右键点击“目标另存为”下载</font>
		<div>导入说明：</div>
	<div>
		<ul>
			<li></li>
		...
		+function(window,document,undefined){
			...
			function showPanel() {
				...
				vault.onAddFile = function(fileName) {
			   	...
			   	vault.setFormField("tableName", "NMK.ENT_GROUP_ASSESS_KPI_RATE_IMPORT_TMP");
		    	vault.setFormField("columns", "TASK_ID,TIME_ID,TYPE,NUM,KPI_NAME,TYPE_SCORE,KPI_SCORE,IND1,IND2,IND3,IND4,IND5,IND6,IND7,IND8,IND9,IND10,IND11,IND12,IND13,IND14,IND15,IND16,IND17,IND18,IND19");
		    	vault.setFormField("date", taskId);  
		    	vault.setFormField("ds","dw");
		    	
		    	vault.onUploadComplete = function(files) {
		    		var _sql = "select count(*) cnt from NMK.ENT_GROUP_ASSESS_KPI_RATE_IMPORT_TMP where task_id='" + taskId + "' ";
						...
						,callback : function(xmlrequest){
							try{
								...
								if(confirm("您确定要将这批数据入库吗?")){
									//删除表中数据
									var sql = encodeURIComponent("DELETE FROM NMK.ENT_GROUP_ASSESS_KPI_RATE_IMPORT");
									sql += "&sqls=" + encodeURIComponent("INSERT INTO NMK.ENT_GROUP_ASSESS_KPI_RATE_IMPORT SELECT ,TIME_ID,TYPE,NUM,KPI_NAME,TYPE_SCORE,KPI_SCORE,IND1,IND2,IND3,IND4,IND5,IND6,IND7,IND8,IND9,IND10,IND11,IND12,IND13,IND14,IND15,IND16,IND17,IND18,IND19 FROM NMK.ENT_GROUP_ASSESS_KPI_RATE_IMPORT_TMP ");
									// 删除临时表的数据
									sql += "&sqls=" + encodeURIComponent("DELETE FROM NMK.ENT_GROUP_ASSESS_KPI_RATE_IMPORT_TMP ");
			...
			function query(){
				var sql = "select * from nmk.ENT_GROUP_ASSESS_KPI_RATE_IMPORT ";
			...
			function down(){
				aihb.AjaxHelper.down({
					sql : "select * from nmk.ENT_GROUP_ASSESS_KPI_RATE_IMPORT with ur"
					,header : _header
					,ds : "dw"
					,isCached : false
