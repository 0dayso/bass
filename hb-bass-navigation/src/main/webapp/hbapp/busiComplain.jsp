...
<script type="text/javascript">
	...
	function toXls() {
		...
		var sql = " select ACC_NBR,(select area_name from mk.bt_area where area_code=user_area_id),case when BRAND_ID in (1,2,3) then '全球通' when BRAND_ID in (4,5,6,7) or brand_id is null then '神州行' when BRAND_ID=8 then '动感地带' else '其他' end,ITEM_NAME_LEV2,ETL_CYCLE_ID,c.rowname ,replace(COMPLAIN_DESC,',','，'),COMPLAIN_NUM,again_complain_num "
						...
						<table align="center" width="99%">
							<tr class="dim_row_submit">
								<td align="right">
									...
									<input type="button" class="form_button" value="图形分析" onClick="tabAdd({id : 'busiComplain',title : '图形分析',url : 'http://10.25.124.115:8080/hbbass/ngbass/analyMain.jsp?pid=274&reportname=关键业务投诉汇总分析'})">
