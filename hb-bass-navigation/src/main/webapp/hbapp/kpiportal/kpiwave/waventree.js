...
function createTable(sid,name,dim){
      ...
      table = ""
		  ...
		  + "	<tr>"
		  + "		<td>"
		  + "		<table background='"+nodepath+"imc_11.gif' border='0' cellpadding='0' cellspacing='0' width='150'>"
		  + "			<tr>"
		  ...
		  + "			</tr>"
		  + "		</table>"
		  + "		<table background='"+nodepath+"imm_04.png' border='0' cellpadding='0' cellspacing='0' height='3' width='150'>"
		  + "			<tr>"
		  + "				<td height='3'></td>"
		  + "			</tr>"
		  + "		</table>"
		  ...
		  + "				<table  background='"+nodepath+"imc_13.gif' border='0' cellpadding='0' cellspacing='0' width='150'>"
		  + "					<tr>"
		  + "						<td style='font-weight:bold;font-size: 12px; color: rgb(88, 118, 160);' align='left' height='20'>&nbsp; "
		  + "						<span id="+sid+"t1f1 ></span></td>"
		  + "                       <td ><img id="+sid+"pt1  src='"+nodepath+"right.gif' border='0'></img></td>"
		  + "                       <td width='3%'></td>"
		  + "					</tr>"
		  ...
		  + "					</tr>"		  
		  + "					<tr>"
		  + "						<td colspan='3' background='"+nodepath+"imc_18.gif'>"
		  + "						<div title='查看详细' style='padding: 0px; font-size: 12px; margin-left: 3px; margin-right: 3px; margin-top: 0px; text-align: left;'>"
		  + "							<img style='cursor:hand;' onclick='showBox(this)' src='"+nodepath+"imc_22.gif'></div>"
		  + "						</td>"
		  + "					</tr>"
		  + "					<tr style='display:none'>"
		  + "						<td colspan='3' background='"+nodepath+"imc_18.gif'>"
		  + "						<div style='padding: 0px; font-size: 12px; margin-left: 3px; margin-right: 3px; margin-top: 0px; text-align: left;'>"
		  + "							<img style='cursor:hand;' onclick='hiddenBox(this)' src='"+nodepath+"imc_23.gif'></div>"
		  + "						</td>"
		  + "					</tr>"
		  + "				</table>"
		  + "				</td>"
		  + "				<tr><td background='"+nodepath+"imc_18.gif'><img src='"+nodepath+"imc_20.gif'></td></tr>"
		  + "			</tr>"
		  + "			</td>"
		  + "			</tr>"
		  + "		</table>"
...
function initTable(name){
	indexCount = 0 ;
 	table = ""
		  ...
		  + "                       <td ><img id='0pt1' src='"+nodepath+"right.gif' border='0'></img></td>"
		  + "					</tr>"
		  + "					<tr style='display:none'>"
		  + "						<td style='font-weight:bold;font-size: 12px; color: rgb(88, 118, 160);' align='left' height='20'>&nbsp; "
...
function fillData(options){
	...
	if(arr[4]>0.05)document.getElementById(options.node_id+"pt1").src=nodepath+"up.gif";
	else if(arr[4]<-0.05)document.getElementById(options.node_id+"pt1").src=nodepath+"down.gif";			
}
...
+"	<div class='close'><img src='../../resources/image/default/tab-close.gif' onclick='remove();'></img></div>"
+"	<div>请选择分析维度</div>"
