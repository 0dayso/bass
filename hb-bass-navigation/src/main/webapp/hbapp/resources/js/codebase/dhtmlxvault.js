...
var dhtmlXVaultObject = function () {
	...
	this.imPath = "imgs/";
	this.strings = {remove:"删除", upload:"上传", done:"完成", error:"错误", btnAdd:"添加文件", btnUpload:"上传", btnClean:"清空"};
...
dhtmlXVaultObject.prototype.create = function (htmlObject) {
	this.parentObject = (typeof htmlObject != "string")?htmlObject:document.getElementById(htmlObject);//修改可以传入Object容器
...
dhtmlXVaultObject.prototype.uploadFile = function (id) {
	if (!this.isUploadFile) {
		...
		this.uploadForm.action = this.pathUploadHandler + /*MeiKefu 2010-3-16 modify ? and &*/
		(this.pathUploadHandler.indexOf("?") > -1 ? "&" : "?") + "sessionId=" + this.sessionId 
		//这个中文在Websphere下就有问题+ "&fileName=" + escape(this.getFileName(this.getCurrentInputFile(id).value)) 
...
/*Mei Kefu在点击上传按钮之前执行*/
dhtmlXVaultObject.prototype.onFileUpload = function () {
	return true;
};
//v.1.5 build 9755
/*
