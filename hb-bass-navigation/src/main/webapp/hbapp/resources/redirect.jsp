<%@ page language="java" import="java.util.*,java.io.File,java.io.IOException" pageEncoding="utf-8"%>
...
try{	
	...
	for(int i = 0; i < list.size(); i++) {
  		...
  		user.setCityName(lines.get("cityname").toString());
	}
}catch(Exception e)
{
	e.printStackTrace();
