...
function setUniversityOr(){
	...
	function viewDetail(id){
		...
		var _url = "${mvcPath}/hbapp/salesmanager/areasale/bureauAudit/bureau_newdel_detail.jsp?id="+ids;
