...
function doSubmit(method)
{
	...
	var sql = "select area_code,mobile_type,imei,supply_name,serv_num,fee_name,innet_date,care_opera,sl_type,care_operator,rec_id,if_mobile,if_region from NWH.IMPORT_IMEI_INFO ";
	sql += cond;
	var orderby = " order by area_code with ur";
	sql += orderby;
	
	var downsql = "select area_code,mobile_type,imei,supply_name,serv_num,fee_name,innet_date,care_opera,sl_type,care_operator,rec_id,if_mobile,if_region from NWH.IMPORT_IMEI_INFO ";
	downsql +=cond;
	downsql +=orderby;
	
	//alert(sql);
	document.form1.sql.value = downsql;
	//var sql="select distinct time_id from nmk.gds_wave_acct_item with ur ";
			...
			<div id="title_div" style="display:none;">
				<table id="resultTable" align="center" width="130%"
					...
					<tr class="grid_title_blue">						
					    ...
					    <td class="grid_title_cell" width="" id="13">是否湖北移动<br>用户使用</td>
					    <td class="grid_title_cell" width="" id="14">是否销售地市<br>移动用户使用</td>
					</tr>
				</table>
			</div>
		</form>
