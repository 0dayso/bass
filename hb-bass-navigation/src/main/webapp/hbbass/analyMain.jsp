<%@ page contentType="text/html; charset=gb2312" deferredSyntaxAllowedAsLiteral="true"%>
...
<head>
	...
	<script src="/hbbass/WebRoot/hbapp/resources/js/default/default.js" type="text/javascript"></script>
	<script src="${mvcPath}/hbapp/resources/js/datepicker/calendar.js" type="text/javascript"></script>
