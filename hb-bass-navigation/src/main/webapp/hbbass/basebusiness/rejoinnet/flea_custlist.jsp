...
function tosubmit()
{
  ...
  document.form1.nextPage2.value=0;
	document.form1.action = "flea_custlist.jsp";
	document.form1.target = "_self";
	document.form1.submit();
}
function todown()
{
	document.form1.action = "flea_custlist_down.jsp";
...
String order=request.getParameter("order")==null?"HIS_BASE_AVG_PAYED_MONEY":request.getParameter("order");
String querysql="";
...
querysql ="select RN_USER_NUMBER,HIS_USER_NUMBER,RN_BASE_BRAND_ID,rn_next_consumelev,HIS_BEFORE_BRAND_ID,RN_BASE_ORG_ID,rn_base_dept_code,RN_BASE_PLAN_ID,HIS_BEFORE_PLAN_ID,"+
 "HIS_BASE_UNPAY_FEE,HIS_BASE_AVG_PAYED_COUNT,HIS_BASE_AVG_PAYED_MONEY,HIS_BEFORE_PLAN_ID,RN_NEXT_CONSUMELEV,his_create_date,HIS_NEXT_LIFE_FLAG,CHANGE_PHONE_FLAG,rn_base_plan_id,HIS_BEFORE_CONSUMELEV  from nmk.DMRN_USER_MS  where  year(rn_date)*100+month(rn_date)>="+starttime+" and year(rn_date)*100+month(rn_date)<="+endtime+" and FLEA_FLAG=1 ";
...
<!-- 隐藏表单区 -->
 ...
 <td colspan="3" align="center" ><div align="left">
   <table border=0 cellpadding=0 cellspacing=0>
     ...
     <td bgcolor=#ffffff style="font-size:10.8pt;color:#ff6622" nowrap>多次重入网客户名单即席查询</td>
     <td></td>
     </tr>
   </table>
 </div></td>
 ...
 <tr>
 <td width=13% align="right" class="query_t">起始时间</td>
 <td width=8% align="left" class="query_v"><select name="starttime">
 <%
 ...
 <td width=12% align="left" class="query_v">
 ...
 <td width=12% align="right" nowrap class="query_t">当前品牌</td>
 ...
 <td width=13% align="right" nowrap class="query_t">当前消费层次</td>
 <td width=22% align="left" class="query_v"><select name="now_consumelev" id="now_consumelev">
 ...
 <td align="right" nowrap class="query_t">在网时长层次</td>
 ...
 <td colspan="2" align="left" nowrap class="query_v"><input type="button" name="confirm" value="查询（OK）" onClick="tosubmit()" />
 &nbsp;&nbsp;&nbsp;
 ...
 <td align="center" width=4%>多次重<br>入网号码</td>
 ...
 <td align="center" width=3%>历史存<br>活标志</td>
 <td align="center" width=3%>换机标志</td>
 <td align="center" width=3%>当前套<br>餐代码</td>
 <td align="center" width=3%>历史套<br>餐代码</td>
 <td align="center" id=21 width=3%><A class="a2" onClick="changeText(21); return sortTable('resultTbody', 11, true,0);" href="#" title="按欠费金额降序排列">历史欠<br>费金额</a></td>
