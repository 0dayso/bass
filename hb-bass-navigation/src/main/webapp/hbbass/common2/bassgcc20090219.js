...
function channelTerminalSpellSQL(spelltype,columns,tables,condition,group,postfix)
{
	...
	else
	{
		...
		//���⴦���ն�
		columnPlaceholder+=",value((select tac_pro from nwh.imei_tacpro_info where tac_pro_id= term_brand),'δ֪'),value((select device_name from nwh.imei_terminal_info where device_id= term_model),'δ֪')";
