...
<fieldset>
    ...
    <table id="resultTable" align="center" width="99%" class="grid-tab-blue" cellspacing="1" cellpadding="0" border="0">
		<tr class="grid_title_blue">
		   ...
		   <span id=2><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">合计#{2}<ai:piece></ai:piece></a></td></span>
		   <span id=3><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{3}<br>欠费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=4><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{4}<br>欠费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=5><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{5}<br>欠费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=6><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{6}<br>欠费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=7><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{7}<br>欠费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=8><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{8}<br>欠费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=9><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{9}<br>欠费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=10><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{10}<br>欠费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=11><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{11}<br>欠费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=12><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{12}<br>欠费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=13><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{13}<br>欠费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=14><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{14}<br>欠费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=15><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">12个月以上<br>欠费(万元)<ai:piece></ai:piece></a></td></span>
		   
		   <span id=16><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{16}<br>欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=17><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{17}<br>欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=18><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{18}<br>欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=19><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{19}<br>欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=20><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{20}<br>欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=21><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{21}<br>欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=22><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{22}<br>欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=23><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{23}<br>欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=24><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{24}<br>欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=25><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{25}<br>欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=26><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{26}<br>欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=27><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">#{27}<br>欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=28><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">12个月以上<br>欠费占比<ai:piece></ai:piece></a></td></span>
...
<script type="text/javascript">
	...
	function doSubmit()
	{
		...
		renderChart("sql="+encodeURIComponent(chartSQL)+"&name="+chartName+"欠费占比&valueType=percent" );
	}
