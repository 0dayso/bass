...
<fieldset>
    ...
    <table id="resultTable" align="center" width="99%" class="grid-tab-blue" cellspacing="1" cellpadding="0" border="0">
		<tr class="grid_title_blue">
		   <span id=0><td class="grid_title_blue_noimage" rowspan="2">地市</td></span>
		   <span id=1><td class="grid_title_blue_noimage" rowspan="2">县市</td></span>
		   <td class="grid_title_blue_noimage" colspan="3">#{0}帐期回收</td>
		   <td class="grid_title_blue_noimage" colspan="3">#{1}帐期回收</td>
		   <td class="grid_title_blue_noimage" colspan="3">#{2}帐期回收</td>
		   </tr>
		   <tr>
		   <span id=2><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">回收欠<br>费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=3><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">赠送科<br>目占比<ai:piece></ai:piece></a></td></span>
		   <span id=4><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">非赠送<br>科目占比<ai:piece></ai:piece></a></td></span>
		   <span id=5><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">回收欠<br>费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=6><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">赠送科<br>目占比<ai:piece></ai:piece></a></td></span>
		   <span id=7><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">非赠送<br>科目占比<ai:piece></ai:piece></a></td></span>
		   <span id=8><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">回收欠<br>费(万元)<ai:piece></ai:piece></a></td></span>
		   <span id=9><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">赠送科<br>目占比<ai:piece></ai:piece></a></td></span>
		   <span id=10><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">非赠送<br>科目占比<ai:piece></ai:piece></a></td></span>
		    </tr>
	</table>
</div>
</fieldset>
