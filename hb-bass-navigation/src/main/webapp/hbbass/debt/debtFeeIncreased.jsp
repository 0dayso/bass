...
<fieldset>
    ...
    <table id="resultTable" align="center" width="130%" class="grid-tab-blue" cellspacing="1" cellpadding="0" border="0">
		<tr class="grid_title_blue">
		   ...
		   <td class="grid_title_cell">品牌</td>
		   <td class="grid_title_cell">基本优惠</td>
		   <span id=4><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">到达用户占比<ai:piece></ai:piece></a></td></span>
		   <span id=5><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">增幅<ai:piece></ai:piece></a></td></span>
		   <span id=6><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">收入占比<ai:piece></ai:piece></a></td></span>
		   <span id=7><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">增幅<ai:piece></ai:piece></a></td></span>
		   <span id=8><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">累计欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=9><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">增幅<ai:piece></ai:piece></a></td></span>
		   <span id=10><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">当月欠费占比<ai:piece></ai:piece></a></td></span>
		   <span id=11><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">增幅<ai:piece></ai:piece></a></td></span>
		   <span id=12><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">通话费占比<ai:piece></ai:piece></a></td></span>
		   <span id=13><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">增幅<ai:piece></ai:piece></a></td></span>
		   <span id=14><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">短信占比<ai:piece></ai:piece></a></td></span>
		   <span id=15><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">增幅<ai:piece></ai:piece></a></td></span>
		   <span id=16><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">GPRS占比<ai:piece></ai:piece></a></td></span>
		   <span id=17><td class="grid_title_cell"><a href='#' onclick="doSubmit(this)">增幅<ai:piece></ai:piece></a></td></span>
		</tr>
	</table>
</div>
</fieldset>
...
<script type="text/javascript">
	...
	function doSubmit()
	{
		...
		var sql=" select (select cityname from FPF_user_city where dm_county_id='-1' and dm_city_id=area_id),(select cityname from FPF_user_city where dm_county_id=county_id ),case when brand_id=1 then '全球通' when brand_id=2 then '神州行' else '动感地带' end,(select fee_name from nwh.fee where fee_id=nbilling_tid)"
