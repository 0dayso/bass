...
<%-- 
	copied from debtHighDetail.jsp,for the link cliked
--%>
<HTML xmlns:ai>
<HEAD>
	<meta http-equiv="Content-Type" content="text/html;charset=utf-8">
	<TITLE>短信高额欠费(欠费50元以上)用户分析-短信高额欠费用户清单</TITLE>
...
<fieldset>
    ...
    <table id="resultTable" align="center" width="99%" class="grid-tab-blue" cellspacing="1" cellpadding="0" border="0">
		<tr class="grid_title_blue">
		   ...
		   <span id=3><td class="grid_title_cell">短信欠费金额</td></span>
...
<script type="text/javascript">
	...
	function doSubmit()
	{
		...
		+",decimal(debtcharge_data_sms_m,16,2)/1000,acc_nbr from nmk.st_debt_high_list_"+document.forms[0].date.value +" where "+condition;
