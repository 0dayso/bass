...
<fieldset>
    ...
    <table id="resultTable" align="center" width="99%" class="grid-tab-blue" cellspacing="1" cellpadding="0" border="0">
		<tr class="grid_title_blue">
		   ...
		   <span id=3><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">去年4季度<ai:piece></ai:piece></a></td></span>
		   <span id=4><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">去年3季度<ai:piece></ai:piece></a></td></span>
		   <span id=5><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">去年2季度<ai:piece></ai:piece></a></td></span>
		   <span id=6><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">去年1季度<ai:piece></ai:piece></a></td></span>
		   <span id=7><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">前年4季度<ai:piece></ai:piece></a></td></span>
		   <span id=8><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">前年3季度<ai:piece></ai:piece></a></td></span>
		   <span id=9><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">前年2季度<ai:piece></ai:piece></a></td></span>
		   <span id=10><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">前年1季度<ai:piece></ai:piece></a></td></span>
		   <span id=11><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">前年以前<ai:piece></ai:piece></a></td></span>
		   
		   <span id=12><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">去年4季度占比<ai:piece></ai:piece></a></td></span>
		   <span id=13><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">去年3季度占比<ai:piece></ai:piece></a></td></span>
		   <span id=14><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">去年2季度占比<ai:piece></ai:piece></a></td></span>
		   <span id=15><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">去年1季度占比<ai:piece></ai:piece></a></td></span>
		   <span id=16><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">前年4季度占比<ai:piece></ai:piece></a></td></span>
		   <span id=17><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">前年3季度占比<ai:piece></ai:piece></a></td></span>
		   <span id=18><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">前年2季度占比<ai:piece></ai:piece></a></td></span>
		   <span id=19><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">前年1季度占比<ai:piece></ai:piece></a></td></span>
		   <span id=20><td class="grid_title_blue_noimage"><a href='#' onclick="doSubmit(this)">前年以前占比<ai:piece></ai:piece></a></td></span>
		  </tr>
	</table>
</div>
</fieldset>
...
<script type="text/javascript">
	...
	function doSubmit()
	{
		...
		if(document.forms[0].indicator.value=="debtcharge_sum"){
			...
			+" ,decimal(sum(case when innet_cycle=16 then %indicator% end),16,2)/10000000"
			+" ,decimal(sum(case when innet_cycle=15 then %indicator% end),16,2)/10000000"
			+" ,decimal(sum(case when innet_cycle=14 then %indicator% end),16,2)/10000000"
			+" ,decimal(sum(case when innet_cycle=13 then %indicator% end),16,2)/10000000"
			+" ,decimal(sum(case when innet_cycle=20 then %indicator% end),16,2)/10000000"
			+" ,decimal(sum(case when innet_cycle=19 then %indicator% end),16,2)/10000000"
			+" ,decimal(sum(case when innet_cycle=18 then %indicator% end),16,2)/10000000"
			+" ,decimal(sum(case when innet_cycle=17 then %indicator% end),16,2)/10000000"
			+" ,decimal(sum(case when innet_cycle=21 then %indicator% end),16,2)/10000000"
		}else{
			sql +=" ,sum(%indicator%)"
			+" ,sum(case when innet_cycle=16 then %indicator% end)"
			+" ,sum(case when innet_cycle=15 then %indicator% end)"
			+" ,sum(case when innet_cycle=14 then %indicator% end)"
			+" ,sum(case when innet_cycle=13 then %indicator% end)"
			+" ,sum(case when innet_cycle=20 then %indicator% end)"
			+" ,sum(case when innet_cycle=19 then %indicator% end)"
			+" ,sum(case when innet_cycle=18 then %indicator% end)"
			+" ,sum(case when innet_cycle=17 then %indicator% end)"
			+" ,sum(case when innet_cycle=21 then %indicator% end)"
		}
		sql +=" ,decimal(sum(case when innet_cycle=16 then %indicator% end),16,2)/sum(%indicator%)"
			+" ,decimal(sum(case when innet_cycle=15 then %indicator% end),16,2)/sum(%indicator%)"
			+" ,decimal(sum(case when innet_cycle=14 then %indicator% end),16,2)/sum(%indicator%)"
			+" ,decimal(sum(case when innet_cycle=13 then %indicator% end),16,2)/sum(%indicator%)"
			+" ,decimal(sum(case when innet_cycle=20 then %indicator% end),16,2)/sum(%indicator%)"
			+" ,decimal(sum(case when innet_cycle=19 then %indicator% end),16,2)/sum(%indicator%)"
			+" ,decimal(sum(case when innet_cycle=18 then %indicator% end),16,2)/sum(%indicator%)"
			+" ,decimal(sum(case when innet_cycle=17 then %indicator% end),16,2)/sum(%indicator%)"
			+" ,decimal(sum(case when innet_cycle=21 then %indicator% end),16,2)/sum(%indicator%)"
			+" from nmk.st_debt_netage_mm where new_flag=0"
			+condition
			+" group by %group%"
			+ " order by " + orderby;
