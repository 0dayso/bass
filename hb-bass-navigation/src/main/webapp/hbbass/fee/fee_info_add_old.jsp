						...
						<TABLE class=grid-tab-blue cellSpacing=1 cellPadding=0 width=99% align=center border=0>
							...
							for(int i = 0 ;i<list.size();i++){
								...
								<TR class=grid_row_blue>
									...
									<TD class=grid_row_cell width="30%"><input type="text" size="60" name="f<%=i %>" value="<%=arr[2] %>"></TD>
...
function save(){
	document.forms(0).action='${mvcPath}/hbirs/action/feeInfo?method=saveFeeInfo';
