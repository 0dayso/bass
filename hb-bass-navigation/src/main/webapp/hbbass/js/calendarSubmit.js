document.write('<iframe id=CalFrame name=CalFrame frameborder=0 src=/hbbass/common/calendarSubmit.htm style=display:none;position:absolute;z-index:100></iframe>');
