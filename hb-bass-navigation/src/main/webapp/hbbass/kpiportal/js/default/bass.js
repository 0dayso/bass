	...
	this.createBody = function() {
		...
		for(i=0;i<cTab.tabLen;i++)
		{
			...
			if(tabAttriable[3])
			{
				...
				tabHTML += "<img src=\"images/default/" + tabIcon + "\" border=\"0\" align=\"absmiddle\" style=\"margin-right:2px;\" />\n";
			}
			tabHTML += tabTitle + "</td>\n";

			if(i>=fixNo)
			{
				tabHTML += "<td class=\""+tabTextClassOff+"\" valign=\"top\" style=\"padding:8px 2px 0 px 0px;cursor:hand;\" id=\"tdCloseTab"+(i+1)+"\"><img src=\"images/default/icon_closetab.gif\" name=\"iconCloseTab"+(i+1)+"\" id=\"iconCloseTab"+(i+1)+"\" onclick=\"theCreateTab.subtract("+i+")\" border=\"0\" /></td>\n";
			}
