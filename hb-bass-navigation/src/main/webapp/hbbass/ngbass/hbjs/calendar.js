document.write('<iframe id=CalFrame name=CalFrame frameborder=0 src=/hbbass/ngbass/hbjs/calendar.htm style=display:none;position:absolute;z-index:100></iframe>');
