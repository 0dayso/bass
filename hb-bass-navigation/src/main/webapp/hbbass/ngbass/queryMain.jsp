...
function doSubmit()
{
	...
	document.getElementById("sqlview").innerHTML=sql+" with ur";//去掉页面上的sql显示
...
{  // 表头控制
		 ...
		 tempHtml+="<tr><td align='center'><a href='#' onclick=\"massage_box2.style.visibility='hidden'\">【关闭】</a></td></tr>";
		 tempHtml+="</table></form>"
