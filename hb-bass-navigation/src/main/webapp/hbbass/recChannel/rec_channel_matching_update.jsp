...
<%
	String[] recChannelMatch = (String[]) request.getAttribute("recChannelMatch");
	//request.getSession().removeAttribute("recChannelMatch");
%>
<html xmlns:ai>
	<head>
		<meta http-equiv="Content-Type" content="text/html;charset=utf-8">
		<title>修改业务受理渠道适配参数</title>
					...
					<div id="grid" style="display: '';">
							...
							<tr class="grid_row_blue">
								...
								<td class="grid_row_cell" width="60%">
									<input type="text" size="42" id="f01" name="f01" value="<%=recChannelMatch[0] %>">
								</td>
							</tr>
							<tr class="grid_row_blue">
								...
								<td class="grid_row_cell">
									<input type="text" size="42" id="f02" name="f02" value="<%=recChannelMatch[1] %>">
								</td>
							</tr>
							<tr class="grid_row_blue">
								<td class="grid_title_blue" align="center">
...
function save(){
	document.forms(0).action='${mvcPath}/hbirs/action/recChannel?method=updateRecChannelMatch';
...
renderSelect($('f03'),'<%=recChannelMatch[2]%>');
renderSelect($('f04'),'<%=recChannelMatch[3]%>');	
renderSelect($('f05'),'<%=recChannelMatch[4]%>');
renderSelect($('f06'),'<%=recChannelMatch[5]%>');
renderSelect($('f07'),'<%=recChannelMatch[6]%>');	
renderSelect($('f08'),'<%=recChannelMatch[7]%>');
renderSelect($('f09'),'<%=recChannelMatch[8]%>');
renderSelect($('f10'),'<%=recChannelMatch[9]%>');	
renderSelect($('f11'),'<%=recChannelMatch[10]%>');		
</script>