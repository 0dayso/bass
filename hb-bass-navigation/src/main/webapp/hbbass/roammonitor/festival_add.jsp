				...
				<fieldset>
					...
					<div id="grid" style="display: '';">
						<table class="grid-tab-blue" cellspacing="1" cellpadding="0" width="99%" align="center" border="0">
							<tr class="dim_row">
								<td class="dim_cell_title" width="60%" align="center">节日名称</td>
								<td class="dim_cell_content" width="40%">
							...
							<tr class="dim_row">
								...
								<td class="dim_cell_content" >
									<input type="text" name="f1003">
								</td>
							</tr>	
							<tr class="dim_row">
								<td class="dim_cell_title" align="center">节日年份</td>
								<td class="dim_cell_content" >
									<input type="text" name="f1004">
								</td>
							</tr>	
						</table>
						<br>
...
function save(){
	document.forms(0).action='${mvcPath}/hbirs/action/roamMonitor?method=saveFestival';
