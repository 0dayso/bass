		...
		<form method="post" action="">
			...
			<div class="divinnerfieldset" >
				<fieldset>
					...
					<div id="grid" style="display: none;" style="margin-top: 5px; margin-left: 10px; margin-right: 10px;"></div>
...
function addBureau(){
	var condi = "  bureau_id not in (select bureau_id from COLLEGE_BUREAU_INFO where 1=1)";
	var _url = "${mvcPath}/hbbass/salesmanager/areasale/bureauAudit/bureau_query.jsp?whereContent="+condi+"&collegeId="+"<%=whereContent%>";
	window.open(_url);
	//tabAdd({url:_url,title:'新增基站'});
}
function delBureau(){
	var ids = "";
	var n = document.getElementsByName('cbox').length;
	...
	var _url = "${mvcPath}/hbirs/action/areaSaleManage?method=collegeDelBureau&collegeId="+"<%=whereContent%>"+"&bureauIds="+ids+"&oldUrl="+oldUrl;
