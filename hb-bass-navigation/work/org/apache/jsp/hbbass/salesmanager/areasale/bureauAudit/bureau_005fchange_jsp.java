 ...
 * Generated at: 2017-08-02 09:38:15 UTC
...
public final class bureau_005fchange_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try{
	...
	if(conn!=null)
      ...
      out.write("\t\t<title>基站归属变更审核</title>\r\n");
      ...
      out.write("\t,{\"name\":\"变更类型\",\"dataIndex\":\"c6\"}\r\n");
      out.write("\t,{\"name\":\"原(父节点)值\",\"dataIndex\":\"c7\"}\r\n");
      out.write("\t,{\"name\":\"新(父节点)值\",\"dataIndex\":\"c8\"}\r\n");
      out.write("\t,{\"name\":\"创建人\",\"dataIndex\":\"c9\"}\r\n");
      out.write("\t,{\"name\":\"创建时间\",\"dataIndex\":\"c9_2\"}\r\n");
      ...
      out.write("\t\tif($('CHANG_TYPE').value != null && $('CHANG_TYPE').value != \"\"){\r\n");
      out.write("\t\t\twherePiece += \" and CHANG_TYPE='\"+$('CHANG_TYPE').value+\"'\";\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t");
      ...
      out.write("\t\tif($('CHANG_TYPE').value != null && $('CHANG_TYPE').value != \"\"){\r\n");
      out.write("\t\t\twherePiece += \" and a.CHANG_TYPE='\"+$('CHANG_TYPE').value+\"'\";\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar sql=\"select '' c0, a.CHANGECELL_SEQ c1, (select dim.itemname from mk.dim_areacity dim where char(dim.region)=area_id) c2, LAC_DEC c3, CELLID_DEC c4, BUREAU_ID c5, case when CHANG_TYPE='ChangeCellName' then '基站名称变更' when CHANG_TYPE='ChangeCellTown' then '基站归属乡镇变更' end c6, case when CHANG_TYPE='ChangeCellTown' then (select name from nwh.bureau_tree c where c.id = OLD_VALUE) else OLD_VALUE end c7, case when CHANG_TYPE='ChangeCellTown' then (select name from nwh.bureau_tree c where c.id = NEW_VALUE) else NEW_VALUE end  c8, CREATEUSER c9,substr(char(CREATE_DATE),1,19) c9_2,  case when STATUS='waitaudit1' then '待一级审核' when STATUS='waitaudit2' then '待二级审核' when STATUS='waitaudit3' then '待三级审核' when STATUS='succ' then '审核通过'  when STATUS='fail' then '审核不通过'  end c10, substr(char(STATE_DATE),1,19) c11,case when eff_type='0' then '立即生效' when eff_type='1' then '下月生效' end c12 from BUREAU_CELL_CHANGE_INFO a,BUREAU_CELL_CHANGE_AUDIT_LOG b where a.CHANGECELL_SEQ = b.CHANGECELL_SEQ and b.OPERATOR = '");
      out.print(userid);
      out.write("' \"\r\n");
      out.write("\t\t\t+ wherePiece\r\n");
      out.write("\t\t\t+ \" and \" + num + \"=\" + num\r\n");
      ...
      out.write("\t\t\t+ getwhere('STATE_DATE') \r\n");
      out.write("\t\t\t+ getwhereDate('CREATE_DATE','date3','date4')\t\r\n");
      out.write("\t\t\t+ \" order by c2, c31,c21,c22,c23\"\r\n");
      out.write("\t\t\t+\" with ur\";\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\treturn sql;\t\r\n");
      out.write("\t}\t\t\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${mvcPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/hbirs/action/jsondata?method=down&sql=\"+genSQL()+\"&fileName=\"+_fileName});\r\n");
      out.write("//}\r\n");
      out.write("\r\n");
      out.write("function down(){\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td class='dim_cell_content'><select id=\"CHANG_TYPE\"><option value=\"\">全部</option><option value=\"ChangeCellTown\" selected=\"selected\">基站归属乡镇变更</option></select></td>\r\n");
      ...
      out.write("\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${mvcPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/hbirs/action/areaSaleManage?method=bureauChange\"\r\n");
      ...
      out.write("\t\tvar _url = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${mvcPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/hbbass/salesmanager/areasale/bureauAudit/bureau_change_detail.jsp?id=\"+ids;\r\n");
