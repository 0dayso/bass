 ...
 * Generated at: 2017-08-02 09:36:59 UTC
...
public final class lac_005fchange_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try{
	...
	if(conn!=null)
      ...
      out.write("\t\t<title>Lac码变更审核</title>\r\n");
      ...
      out.write("\t,{\"name\":\"区域营销中心\",\"dataIndex\":\"c11\"}\r\n");
      out.write("\t,{\"name\":\"区域营销中心代码\",\"dataIndex\":\"c21\"}\r\n");
      out.write("\t,{\"name\":\"镇\",\"dataIndex\":\"c12\"}\r\n");
      out.write("\t,{\"name\":\"基站\",\"dataIndex\":\"c13\"}\r\n");
      out.write("\t,{\"name\":\"原lac码\",\"dataIndex\":\"c3\"}\r\n");
      out.write("\t,{\"name\":\"新lac码\",\"dataIndex\":\"c4\"}\r\n");
      out.write("\t,{\"name\":\"cell码\",\"dataIndex\":\"c5\"}\r\n");
      out.write("\t,{\"name\":\"创建人\",\"dataIndex\":\"c6\"}\r\n");
      out.write("\t,{\"name\":\"创建日期\",\"dataIndex\":\"c7\"}\r\n");
      out.write("\t,{\"name\":\"状态\",\"dataIndex\":\"c8\"}\r\n");
      out.write("\t,{\"name\":\"状态时间\",\"dataIndex\":\"c9\"}\r\n");
      out.write("\t,{\"name\":\"生效类型\",\"dataIndex\":\"c10\"}\r\n");
      out.write("];\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t+ \" and \" + num + \"=\" + num\t\r\n");
      out.write("\t\t\t+ getwhere('STATE_DATE') \r\n");
      out.write("\t\t\t+ \" order by c2,c11,c12,c13\"\r\n");
      out.write("\t\t\t+\" with ur\";\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\treturn sql;\t\r\n");
      out.write("\t}\t\t\r\n");
      ...
      out.write("\t}\t\r\n");
      out.write("\tdiv #grid table{width:100%;}\r\n");
      out.write("\t</style>\t\r\n");
      out.write("\t</head>\r\n");
      out.write("\t<body>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td class='dim_cell_title' id=\"times_start\" >启始时间:</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class='dim_cell_content' id=\"times_start1\"> <input type=\"text\" value='");
      out.print(defaultDate);
      out.write("' id=\"sdate1\" onfocus=\"WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})\" class=\"Wdate\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class='dim_cell_title' id=\"times_end\" >结束时间:</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class='dim_cell_content' id=\"times_end1\" ><input type=\"text\" value='");
      out.print(defaultDate);
      out.write("' id=\"sdate2\" onfocus=\"WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})\" class=\"Wdate\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr class='dim_row'>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!--  \r\n");
      out.write("\t\t\t\t\t\t\t\t<td class='dim_cell_title'>操作类型</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class='dim_cell_content'><select id=\"CHANG_TYPE\"><option value=\"\">全部</option><option value=\"ChangeCellName\">ChangeCellName</option><option value=\"ChangeCellTown\">ChangeCellTown</option></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t-->\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t<td class='dim_cell_content' id=\"status_td2\" style=\"display: none\"><select id=\"STATUS\"><option value=\"\">全部</option><option value=\"waitaudit1\">待一级审核</option><option value=\"waitaudit2\">待二级审核</option><option value=\"waitaudit3\">待三级审核</option><option value=\"succ\">审核通过</option><option value=\"fail\">审核不通过</option></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class='dim_cell_title_wide' id=\"eff_td1\">审批生效类型(非查询条件，仅供审批使用)</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class='dim_cell_content' id=\"eff_td2\" ><select id=\"eff_type\"><option value=\"\">不更改</option><option value=\"0\">立即生效</option><option value=\"1\">下月生效</option></select></td>\t\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${mvcPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/hbirs/action/areaSaleManage?method=lacChange\"\r\n");
      ...
      out.write("\t\tvar _url = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${mvcPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/hbbass/salesmanager/areasale/bureauAudit/lac_change_detail.jsp?id=\"+ids;\r\n");
      out.write("\t\ttabAdd({url:_url,title:'明细'});\r\n");
      out.write("\t}\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("</script>\r\n");
