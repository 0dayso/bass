...
public class Encryption {
	...
	public static String decrypt(String s){
		try{
			...
			return new String(_instance.decode(_instance.hex2byte(s),
					_instance.hex2byte(_instance.hexKey)));
		}catch(Exception e){
			e.printStackTrace();
			return s;
		}	
	...
	public static String getRandomMsgId() {
		char[] chs = new char[] { 'Q', '@', '8', 'y', '%', '^', '5', 'Z', '(', 'G', '_', 'O', '`',  
	              'S', '-', 'N', '<', 'D', '{', '}', '[', ']', 'h', ';', 'W', '.',  
	              '/', '|', ':', '1', 'E', 'L', '4', '&', '6', '7', '#', '9', 'a',  
	              'A', 'b', 'B', '~', 'C', 'd', '>', 'e', '2', 'f', 'P', 'g', ')',  
 	...
 	public static void main(String[] args) {
 		System.out.println(Encryption.encrypt("Jfqt@2017"));
 	}
//	
	/*
