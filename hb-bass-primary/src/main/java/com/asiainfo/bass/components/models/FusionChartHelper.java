...
public class FusionChartHelper {
	...
	public static String radar(List data, Options options) {
		StringBuffer sb = new StringBuffer();

		sb.append("<chart baseFontSize='12' bgAlpha='0,0' canvasBgAlpha='0,0' caption='").append(options.getCaption()).append("' formatNumberScale='0'").append(" numdivlines='").append(options.getNumDivLines()).append("'").append(" showNames='").append(options.getShowNames()).append("'").append(" rotateNames='")
				.append(options.getRotateNames()).append("'").append(" showValues='").append(options.getShowValues()).append("'");

		if (options.fontColor.length() > 0) {
			sb.append(" outCnvBaseFontColor='").append(options.fontColor).append("' ");
		}
		...
		for (int i = 0; i < data.size(); i++) {
			...
			category.append("<category label='" + arr[0] + "'/>");
			dataset.append("<set value='" + arr[1] + "'/>");
		...
		sb.append(" yaxisminvalue='").append(formatMinValue).append("' yaxismaxvalue='").append(formatMaxValue).append("' >").append(category).append(dataset).append("</chart>");
	...
	public static String chartNormal(List list, Options options) {
		...
		sb.append("<graph baseFontSize='12' bgAlpha='0,0' canvasBgAlpha='0,0' caption='").append(options.getCaption()).append("' formatNumberScale='0'").append(" numdivlines='").append(options.getNumDivLines()).append("'").append(" showNames='").append(options.getShowNames()).append("'").append(" rotateNames='")
				.append(options.getRotateNames()).append("'").append(" showValues='").append(options.getShowValues()).append("'");
	...
	public static String chartMultiCol(List list, Options options) {
		...
		sb.append("<graph baseFontSize='12' bgAlpha='0,0' canvasBgAlpha='0,0' caption='").append(options.getCaption()).append("' formatNumberScale='0'").append(" numdivlines='").append(options.getNumDivLines()).append("'").append(" showNames='").append(options.getShowNames()).append("'").append(" rotateNames='")
				.append(options.getRotateNames()).append("'").append(" showValues='").append(options.showValues).append("'");
	...
	public static String chartColLineDY(List list, Options options) {
		...
		sb.append("<graph baseFontSize='12' bgAlpha='0,0' canvasBgAlpha='0,0' caption='").append(options.getCaption()).append("' formatNumberScale='0' showSecondaryLimits='0' showLegend='0' showDivLineSecondaryValue='0' ").append(" numdivlines='").append(options.getNumDivLines()).append("'").append(" showNames='")
				.append(options.getShowNames()).append("'").append(" rotateNames='").append(options.getRotateNames()).append("'").append(" showValues='").append(options.getShowValues()).append("'");
