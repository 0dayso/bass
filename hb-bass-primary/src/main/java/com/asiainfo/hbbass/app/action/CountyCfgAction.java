...
public class CountyCfgAction extends Action {

	private static Logger log = Logger.getLogger(CountyCfgAction.class);
	 ...
	 * @throws IOException
	 */
	public void deleteCountyCfg(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String lac_dec = request.getParameter("lac_dec");
		String cellid_dec = request.getParameter("cellid_dec");
		Connection conn = null;
		PreparedStatement ps = null;
		String sql = "";
		try {
			sql = "delete from nwh.county_cfg_template where lac_dec = '" + lac_dec + "' and cellid_dec = '" + cellid_dec + "'";
		...
		response.sendRedirect("/hb-bass-navigation/hbbass/town/county_cfg.jsp");
	}
