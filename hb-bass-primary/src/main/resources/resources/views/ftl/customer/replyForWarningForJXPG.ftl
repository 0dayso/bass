...
<script type="text/javascript">
	...
	function query(){
		...
		var grid = new aihb.CommonGrid({
			...
			,url:"${mvcPath}/customer/getReplyForWarningForJXPGInfo"
		});
		grid.run();
	}
	...
	var _header=[
		...
		,{"name":"营销类型","dataIndex":"fee_name","cellStyle":"grid_row_cell_text"}
	...
	function save(){
		...
		$.ajax({
			...
			,data: "time_id="+time_id+"&area_code="+area_code+"&fee_id="+fee_id+"&fee_name="+fee_name+"&type=2&reply="+reply_content
			,dataType : "json"
