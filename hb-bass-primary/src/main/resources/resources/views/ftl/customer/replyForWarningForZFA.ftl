...
<script type="text/javascript">
	...
	function view(){
		var time='${time_id}';
        var fee_id="nbilling_tid$"+'${fee_id}';
		tabAdd({title:'客户价值资费案监控预警号码级清单明细',id: 16044,url:"${mvcPath}/report/16044?time="+time+"&condition="+fee_id});
	}
	...
	function save(){
		...
		$.ajax({
			...
			,data: "time_id="+time_id+"&area_code="+area_code+"&fee_id="+fee_id+"&fee_name="+fee_name+"&type=4&reply="+reply_content
			,dataType : "json"
	...
	function query(){
		...
		var grid = new aihb.CommonGrid({
			...
			,url:"${mvcPath}/customer/getReplyForWarningForZFA"
		});
		grid.run();
	}
	...
	var _header=[
		...
		,{"name":"离网用户占比","dataIndex":"outnet_rate","cellStyle":"grid_row_cell_text"}
		,{"name":"零次用户占比","dataIndex":"zero_rate","cellStyle":"grid_row_cell_text"}
		,{"name":"负价值用户占比","dataIndex":"low_value_rate","cellStyle":"grid_row_cell_text"}
		,{"name":"欠费用户占比","dataIndex":"owe_rate","cellStyle":"grid_row_cell_text"}
		,{"name":"MOU","dataIndex":"mou","cellStyle":"grid_row_cell_text"}
		,{"name":"DOU","dataIndex":"dou","cellStyle":"grid_row_cell_text"}
		...
		,{"name":"网间结算成本","dataIndex":"stl_outnet_cost","cellStyle":"grid_row_cell_text"}
		,{"name":"网内结算成本","dataIndex":"stl_innet_cost","cellStyle":"grid_row_cell_text"}
		...
		,{"name":"其他:出售终端,SIM","dataIndex":"other_cost","cellStyle":"grid_row_cell_text"}
