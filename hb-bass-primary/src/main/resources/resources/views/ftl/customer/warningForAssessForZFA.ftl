...
<script type="text/javascript">
	...
	function query(){
		...
		var grid = new aihb.CommonGrid({
			...
			,url:"${mvcPath}/customer/getWarningForAssessForZFA"
		});
		grid.run();
	}
	...
	var _header=[
		...
		,{"name":"MOU","dataIndex":"mou","cellStyle":"grid_row_cell"}
		,{"name":"DOU","dataIndex":"dou","cellStyle":"grid_row_cell"}
		...
		,{"name":"网间结算成本","dataIndex":"stl_outnet_cost","cellStyle":"grid_row_cell"}
		,{"name":"网内结算成本","dataIndex":"stl_innet_cost","cellStyle":"grid_row_cell"}
