riot.tag2('reporttable', '<table class="table table-bordered"> <thead class="ReportTable-thead"> <tr> <th class="ReportTable-thead-name">名称</th> <th class="ReportTable-thead-desc">描述</th> <th class="ReportTable-thead-date">更新时间</th> <th class="ReportTable-thead-type">报表类型</th> <th class="ReportTable-thead-dell">操作</th> </tr> </thead> <tbody class="ReportTable-tbody"></tbody> </table>', '', 'class="ReportTable"', function(opts) {
	var _this=this;
