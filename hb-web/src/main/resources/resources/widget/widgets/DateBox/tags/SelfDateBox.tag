<SelfDateBox class="SelfDateBox">
	<span class="SelfDateBox-name" if={opts.name}>{opts.name} : </span>
	<div class="SelfDateBox-start-div">
		<label class='SelfDateBox-start'>{startvalue}</label>
	</div>
	<span class="SelfDateBox-split">~</span>
	<div class="SelfDateBox-end-div">
		<label class='SelfDateBox-end'>{endvalue}</label>
	</div>
